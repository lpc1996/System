...
public class CookUtil {
     ...
     * @param value
     */
    public static void addCookie(HttpServletResponse response, String name, String value,int endTime){
        Cookie cookie = new Cookie(name.trim(), value.trim());
        cookie.setMaxAge(endTime * 60);// 设置为30min
        cookie.setPath("/");
